...
public class SwerveUtil {
     ...
     */
    public static SwerveModulePosition[] setModulePositions(MAXSwerveModule[] moduleIO) {
     ...
     */
    public static void addSwerveSimulation(MAXSwerveModule[] moduleIO, SwerveModuleState[] actualStates,
     ...
     * @param kinematics   Object representing kinematics class
     */
    public static double addFakeGyro(MAXSwerveModule[] moduleIO, SwerveModuleState[] actualStates,
            SwerveDriveKinematics kinematics) {
     ...
     */
    public static void updateTelemetry(MAXSwerveModule[] moduleIO) {
        // Update moduleIO's sim objects with a dt of 0.02
